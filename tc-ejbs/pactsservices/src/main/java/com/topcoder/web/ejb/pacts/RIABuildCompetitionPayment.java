...
/**
 * Payment class for RIA Build Competition projects.
 *
 ...
 */
public class RIABuildCompetitionPayment extends ComponentProjectReferencePayment {
    ...
    /**
     * Creates a RIA Build Competition payment using the specified parameters.
     *
     ...
     */
    public RIABuildCompetitionPayment(long coderId, double grossAmount, String client, long projectId, int placed) {
        super(RIA_BUILD_COMPETITION_PAYMENT, coderId, grossAmount, client, projectId, placed);
    }
     ...
     * @param placed the place of the coder in the contest.
     */
    public RIABuildCompetitionPayment(long coderId, double grossAmount, long projectId, int placed) {
     ...
     * @param projectId project that is being paid.
     */
    public RIABuildCompetitionPayment(long coderId, double grossAmount, String client, long projectId) {
     ...
     * @param projectId project that is being paid.
     */
    public RIABuildCompetitionPayment(long coderId, double grossAmount, long projectId) {
    ...
    /**
     * Processor for RIA Build Competition payments.
     *
     * This class will implement <code>lookupDescription</code> to allow custom description
     * generation for the RIA Build Competition payment.
     */
    protected static class Processor extends ComponentProjectReferencePayment.Processor {
         ...
         */
        private static final String PAYMENT_DESCRIPTION_SUFFIX = " - RIA Build Competition";
