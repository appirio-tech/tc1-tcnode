...
/**
 * Payment for deployment work associated with a cockpit project.
 *
 * VERY IMPORTANT: remember to update serialVersionUID if needed
 *
 * @author VolodymyrK
 */
public class ProjectDeploymentTaskPayment extends CockpitProjectReferencePayment {
    ...
    /**
     * Creates a deployment task payment associated with a cockpit project.
     *
     ...
     */
    public ProjectDeploymentTaskPayment(long coderId, double grossAmount, String client, long projectId) {
        super(PROJECT_DEPLOYMENT_TASK_PAYMENT, coderId, grossAmount, client, projectId);
    }
     ...
     * @param projectId project that is being paid.
     */
    public ProjectDeploymentTaskPayment(long coderId, double grossAmount, long projectId) {
    ...
    protected static class Processor extends CockpitProjectReferencePayment.Processor {
        ...
        public String lookupDescription(BasePayment payment) throws SQLException {
            return super.lookupReferenceDescription(payment) + " - Deployment Task";
        }
    }
}
