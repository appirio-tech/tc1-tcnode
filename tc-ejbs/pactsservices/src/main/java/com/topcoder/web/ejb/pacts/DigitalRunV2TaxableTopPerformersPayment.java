...
/**
 * Payment for a taxable Digital Run V2 Top Performers.
 *
 ...
 *
 */
public class DigitalRunV2TaxableTopPerformersPayment extends DigitalRunTrackReferencePayment {
     ...
     */
    public DigitalRunV2TaxableTopPerformersPayment(long coderId, double grossAmount, long trackId) {
     ...
     */
    public DigitalRunV2TaxableTopPerformersPayment(long coderId, double grossAmount, long trackId, int placed) {
        super(DIGITAL_RUN_V2_TAXABLE_TOP_PERFORMERS_PAYMENT, coderId, grossAmount, trackId, placed);
    }
    ...
    protected static class Processor extends DigitalRunTrackReferencePayment.Processor {
        ...
        public String lookupDescription(BasePayment payment) throws SQLException {
            ...
            return getTrackName(p.getTrackId()) + " Top Performers " + getOrdinal(p.getPlaced()) + " (taxable)";
        }
