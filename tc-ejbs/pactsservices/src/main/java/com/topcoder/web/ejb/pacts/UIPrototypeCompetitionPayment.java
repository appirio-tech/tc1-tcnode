...
/**
 * Payment class for UI Prototype Competition projects.
 *
 ...
 */
public class UIPrototypeCompetitionPayment extends ComponentProjectReferencePayment {
    ...
    /**
     * Creates a UI Prototype Competition payment using the specified parameters.
     *
     ...
     */
    public UIPrototypeCompetitionPayment(long coderId, double grossAmount, String client, long projectId, int placed) {
        super(UI_PROTOTYPE_COMPETITION_PAYMENT, coderId, grossAmount, client, projectId, placed);
    }
     ...
     * @param placed the place of the coder in the contest.
     */
    public UIPrototypeCompetitionPayment(long coderId, double grossAmount, long projectId, int placed) {
     ...
     * @param projectId project that is being paid.
     */
    public UIPrototypeCompetitionPayment(long coderId, double grossAmount, String client, long projectId) {
     ...
     * @param projectId project that is being paid.
     */
    public UIPrototypeCompetitionPayment(long coderId, double grossAmount, long projectId) {
    ...
    /**
     * Processor for UI Prototype Competition payments.
     *
     * This class will implement <code>lookupDescription</code> to allow custom description
     * generation for the UI Prototype Competition payment.
     */
    protected static class Processor extends ComponentProjectReferencePayment.Processor {
         ...
         */
        private static final String PAYMENT_DESCRIPTION_SUFFIX = " - UI Prototype Competition";
