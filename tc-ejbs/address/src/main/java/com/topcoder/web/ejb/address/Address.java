...
public interface Address extends EJBObject {
     ...
     */
    long getAddressTypeId(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getAddress1
     */
    String getAddress1(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getAddress2
     */
    String getAddress2(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getAddress3
     */
    String getAddress3(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getCity
     */
    String getCity(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getStateCode
     */
    String getStateCode(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getProvince
     */
    String getProvince(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getZip
     */
    String getZip(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    /**
     * @see com.topcoder.web.ejb.address.AddressBean#getCountryCode
     */
    String getCountryCode(long addressId, String dataSource) throws RemoteException, RowNotFoundException;

    String getCountryName(String countryCode, String dataSource) throws RemoteException, RowNotFoundException;
    ...
    String getAddressTypeDesc(long addressId, String dataSource)
            throws RemoteException, RowNotFoundException;
}
