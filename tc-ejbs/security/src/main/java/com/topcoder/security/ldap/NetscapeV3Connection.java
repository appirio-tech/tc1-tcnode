...
class NetscapeV3Connection implements LDAPSDKConnection {
    ...
    /**
     * <p>A <code>LDAPConnection</code> to be used for establishing connections to target <code>LDAP</code> server and
     * which is delegated all the actual job for commuunicating to <code>LDAP</code> server and performing various
     ...
     *     <li>LDAPSDKException:An unknown error was found.</li>
     * </ul>
     *
     ...
     * @throws IllegalArgumentException if <code>port</code> is negative or greater than 65535 or <code>host</code> is
     *         an empty string.
     */
...
//                connection.setSocketFactory(new JSSESocketFactory(null));
     ...
     *     <li>LDAPSDKCommunicationException:this exception is thrown when an operation was unsuccesfull because of an
     *     error in the communication with the server or in the server</li>
     *     <li>LDAPSDKAccesDeniedException: the operation could not be completed due insufficient access rights.</li>
     *     <li>LDAPSDKLimitsExceededException:Processing time or maximum entries found in the server exceeded its
     *     limits.</li>
     *     <li>LDAPSDKSchemaViolationException:The operation could no be completed because it would violate the LDAP
     *     schema.</li>
     *     <li>LDAPSDKInvalidAttributeSyntaxException:The attribute syntax is invalid</li>
     *     <li>LDAPSDKInvalidDNSyntaxException:The DN syntax of the Entry is invalid</li>
     *     <li>LDAPSDKCallErrorException:The call to an LDAP service was unsuccesfull due to a protocol difference, a
     *     bad parameter or not supported functionality.</li>
     *     <li>LDAPSDKException:An unknown error was found.</li>
     * </ul>
     ...
     *     <li>LDAPSDKInvalidDNSyntaxException:The DN syntax is invalid</li>
     *     <li>LDAPSDKCallErrorException:The call to an LDAP service was unsuccesfull due to a protocol difference, a
     *     bad parameter or not supported functionality.</li>
     ...
     *     <li>LDAPSDKCommunicationException:this exception is thrown when an operation was unsuccesfull because of an
     *     error in the communication with the server or in the server</li>
     *     <li>LDAPSDKAccessDeniedException: the operation could not be completed due insufficient access rights.</li>
     *     <li>LDAPSDKLimitsExceededException:Processing time or maximum entries found in the server exceeded its
     *     limits.</li>
     *     <li>LDAPSDKSchemaViolationException:The operation could no be completed because it would violate the LDAP
     *     schema.</li>
     *     <li>LDAPSDKNoSuchObjectException:The entry was not found.</li>
     *     <li>LDAPSDKInvalidDNSyntaxException:The DN syntax is invalid for dn or newDN</li>
     *     <li>LDAPSDKCallErrorException:The call to an LDAP service was unsuccesfull due to a protocol difference, a
     *     bad parameter or not supported functionality.</li>
    ...
    /**
     * <p>Read an entry from the LDAP and retrieve all the attributes.</p>
     * <p>Throws an LDAPSDKException or one of its inherited exceptions:</p>
     * <ul type="disc">
     *     <li>LDAPSDKCommunicationException:this exception is thrown when an operation was unsuccesfull because of an
     *     error in the communication with the server or in the server</li>
    ...
    /**
     * <p>Read an entry from the LDAP and retrieve the specified attributes </p>
     * <p>Throws an LDAPSDKException or one of its inherited exceptions:</p>
     * <ul type="disc">
     *     <li>LDAPSDKCommunicationException:this exception is thrown when an operation was unsuccesfull because of an
     *     error in the communication with the server or in the server</li>
     ...
     *     <li>LDAPSDKInvalidDNSyntaxException:The DN syntax for the base is invalid</li>
     *     <li>LDAPSDKCallErrorException:The call to an LDAP service was unsuccesfull due to a protocol difference, a
     *     bad parameter or not supported functionality.</li>
     *     <li>LDAPSDKException:An unknown error was found.</li>
     * </ul>
    ...
    /**
     * <p>Builds a Netscape's <code>LDAPEntry</code> object from TC LDAP SDK <code>Entry</code> object.</p>
     *
    ...
    private LDAPEntry buildLDAPEntry(Entry entry) {
        ...
        return new LDAPEntry(entry.getDn(), attributeSet);
    }

    /**
     * <p>A helper method building the <code>Entry</code> object accepted by <code>LDAP SDK Interface</code> component
     * from specified <code>LDAPEntry</code> object provided by <code>Netscape LDAP SDK</code>.</p>
     *
    ...
    /**
     * <p>A helper method building the <code>LDAPModificationSet</code> object accepted by
     * <code>Netscape LDAP SDK</code> from specified <code>Update</code> object.</p>
     *
    ...
    /**
     * <p>A helper method converting the LDAP modification types declared by <code>LDAP SDK Interface</code> component
     * to corresponding LDAP modification types declared by <code>Netscape LDAP SDK</code>.</p>
     *
    ...
    private class LDAPSearchResultsIterator implements Iterator {
        ...
        /**
         * <p>Constructs new <code>LDAPSearchResultsIterator</code> to iterate over specified search results.</p>
         *
        ...
        /**
         * <p>Returns true if the iteration has more elements. (In other words, returns true if next would return an
         * element rather than throwing an exception.)</p>
         *
