...
import com.topcoder.web.winformula.model.*;
...
public class AddDocument extends Base {
    ...
    protected void dbProcessing() throws Exception {
        ...
        if ("".equals(StringUtils.checkNull(contestId))) {
            ...
            DocumentType docType = WinformulaDAOUtil.getFactory().getDocumentTypeDAO().find(new Integer(dt));
            if (docType == null) {
            ...
            MimeType mt = WinformulaDAOUtil.getFactory().getMimeTypeDAO().find(file.getContentType());
