<%@ page import="com.topcoder.web.winformula.Constants, com.topcoder.web.winformula.model.SubmissionType" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        new Image().src = "/i/events/winformula/interface/processing.gif";
        function showProcessing() {
            document.getElementById("submitButton").innerHTML = '<img src="/i/events/winformula/interface/processing.gif" alt=""/>';
        }
...
<%--
<div class="linkBox">
    <winformula:forumLink forumID="${contest.forumId}"/>
</div>
...
<%--
                    <td class="headerC">
                        Ranking
                        <div>
                            <a href="#" onclick="batchUpdate();return false;"><img src="/i/events/winformula/interface/btnUpdateRanking.png" alt="Update ranking" /></a>
                        </div>
                    </td>
--%>
