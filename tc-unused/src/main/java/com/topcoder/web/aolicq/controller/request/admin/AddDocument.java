...
import com.topcoder.web.aolicq.model.*;
...
public class AddDocument extends Base {
    ...
    protected void dbProcessing() throws Exception {
        ...
        if ("".equals(StringUtils.checkNull(contestId))) {
            ...
            DocumentType docType = AolicqDAOUtil.getFactory().getDocumentTypeDAO().find(new Integer(dt));
            if (docType == null) {
            ...
            MimeType mt = AolicqDAOUtil.getFactory().getMimeTypeDAO().find(file.getContentType());
