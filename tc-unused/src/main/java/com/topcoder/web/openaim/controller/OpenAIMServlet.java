package com.topcoder.web.openaim.controller;
...
/**
 * @author dok
 * @version $Revision: 68924 $ Date: 2005/01/01 00:00:00
 *          Create Date: Jun 22, 2006
 */
public class OpenAIMServlet extends BaseServlet {
    private static final Logger log = Logger.getLogger(OpenAIMServlet.class);
...
*/
    ...
    protected String getProcessor(String key) {
        ...
        if (ret.equals(key)) {
            ...
            TCResourceBundle bundle = new TCResourceBundle("OpenAIM");
            try {
