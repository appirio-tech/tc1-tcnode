...
/**
 * @author dok
 * @version $Revision: 68832 $ Date: 2005/01/01 00:00:00
...
public class ViewSubmissions extends ShortHibernateProcessor {
    ...
    protected void dbProcessing() throws Exception {
        ...
        Contest c = OpenAIMDAOUtil.getFactory().getContestDAO().find(new Long(contestId));
        if (c == null) {
        ...
        DataAccess da = new CachedDataAccess(DBMS.OPENAIM_DATASOURCE_NAME);
