...
import com.topcoder.web.openaim.model.*;
...
public class AddDocument extends Base {
    ...
    protected void dbProcessing() throws Exception {
        ...
        if ("".equals(StringUtils.checkNull(contestId))) {
            ...
            DocumentType docType = OpenAIMDAOUtil.getFactory().getDocumentTypeDAO().find(new Integer(dt));
            if (docType == null) {
            ...
            MimeType mt = OpenAIMDAOUtil.getFactory().getMimeTypeDAO().find(file.getContentType());
