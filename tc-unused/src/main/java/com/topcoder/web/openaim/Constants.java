...
/**
 * @author dok
 * @version $Revision: 68988 $ Date: 2005/01/01 00:00:00
 *          Create Date: Jun 22, 2006
 */
public class Constants implements WebConstants {
    private static final TCResourceBundle bundle = new TCResourceBundle("OpenAIM");
    ...
    public static int OPEN_AIM_SECURITY_GROUP_ID;
