...
public abstract class Base extends ShortHibernateProcessor {
    ...
    protected void loadGeneralEditContestData() throws Exception {
        getRequest().setAttribute("docTypes", TruveoDAOUtil.getFactory().getDocumentTypeDAO().getDocumentTypes());
        getRequest().setAttribute("contestStatuses", TruveoDAOUtil.getFactory().getContestStatusDAO().getContestStatuses());
        getRequest().setAttribute("fileTypes", TruveoDAOUtil.getFactory().getFileTypeDAO().getFileTypes());
        ...
        getRequest().setAttribute("prizeTypes", TruveoDAOUtil.getFactory().getPrizeTypeDAO().getPrizeTypes());
    ...
    protected void loadEditContestData(Contest contest) throws Exception {
        ...
        for (Object anA : a) {
            fileTypes.add(((TruveoFileType) anA).getId().toString());
        }
