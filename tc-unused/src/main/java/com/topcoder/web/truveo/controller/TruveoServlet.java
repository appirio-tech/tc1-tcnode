package com.topcoder.web.truveo.controller;
 ...
 */
public class TruveoServlet extends BaseServlet {
    private static final Logger log = Logger.getLogger(TruveoServlet.class);
...
*/
    ...
    protected String getProcessor(String key) {
        ...
        if (ret.equals(key)) {
            ...
            TCResourceBundle bundle = new TCResourceBundle("Truveo");
            try {
