...
/**
 * @author dok
 * @version $Revision: 59128 $ Date: 2005/01/01 00:00:00
 *          Create Date: Mar 1, 2007
 */
public class ProjectDetails extends StatBase {

    protected String getCommandName() {
        return "tco07_project_details";
    }
    ...
    protected void statProcessing() throws TCWebException {
        ...
        ResultSetContainer rsc = (ResultSetContainer) result2.get("tco07_project_results");
