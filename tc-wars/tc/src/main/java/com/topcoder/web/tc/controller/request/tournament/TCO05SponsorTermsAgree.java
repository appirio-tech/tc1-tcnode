    ...
    protected void businessProcessing() throws Exception {
        ...
        if (getUser().isAnonymous()) {
            ...
            if (!hasErrors()) {
                ...
                try {
                    tm.begin();
                    if (!ut.hasTermsOfUse(getUser().getId(), Constants.TCO05_SPONSOR_TERMS_ID)) {
                        ut.createUserTermsOfUse(getUser().getId(), Constants.TCO05_SPONSOR_TERMS_ID);
                    }
