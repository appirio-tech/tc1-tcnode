...
<p>
    <h2>2014 [topcoder] Asia Multi-University Programming Competition</h2>

    <br>

    <h3>The Event</h3>
    [topcoder] is sponsoring a programming competition on Friday 08.22 2014 10:00am CST (China Standard Time) UTC/GMT +8 hours.<br><br>

    <span class="bigRed">Registration for this event is from Tuesday 08.19 2014 2:30pm CST (China Standard Time) to Friday 08.22 2014 10:00am CST (China Standard Time).</span><br>
    <br>
    ...
    <ul>
            <li>1st place finisher will win an iPod Shuffle.
            </li>

            <li>2nd place from will win an iPod Shuffle.
            </li>


            <li>3rd place from will win an iPod Shuffle.
            </li>

            <li>All new registrants since Tuesday 08.19 2014 2:30pm CST from participating universities will receive a Maxwell-topcoder t-shirt.
            </li>
