...
<div class="fixedWidthBody">
        ...
        <p>
            ...
            <ol>
                <li><A href="http://www.topcoder.com/?action=callback&utmSource=yingying&utmCampaign=SRM&utmMedium=July28" target="blank">Sign up</a> as a [topcoder] member</li>
                <li>
                    <A href="/tc?module=IntroEventRegister&eid=${event.id}" target="blank">Register</A> this [topcoder] competition
                </li>
            </ol>
            ...
            [topcoder] Arena can be run as an applet from within your web browser or as a standalone Java Web Start application (recommended).
            In order to compete, you will need to have Java installed on your computer (<A href="http://java.sun.com/" target="_blank">Sun
