 ...
 *
 * This JSP shows algorithm online qualification round 2 summary page.
 *
 * Author TCSDEVELOPER
 * Version 1.0
                                    ...
                                    <div class="bottomArea">
                                        <div class="bottomLeft"><div class="bottomRight">
                                            ...
                                            <jsp:include page="../../secondaryNav.jsp" >
                                                <jsp:param name="mainTab" value="algorithm"/>
                                                <jsp:param name="secondaryTab" value="summary"/>
                                            </jsp:include>

                                            <jsp:include page="../../tertiaryNav.jsp" >
                                                <jsp:param name="mainTab" value="algorithm"/>
                                                <jsp:param name="secondaryTab" value="summary"/>
                                                <jsp:param name="tertiaryTab" value="onlineQualificationRound2"/>
                                            </jsp:include>
