                                                        ...
                                                        <div>   
                                                            <div class="pageContent">
                                                                <h2 class="title">Architecture Competition Final Results</h2>
                                                                    ...
                                                                    <p>Three strong competitors posted the maximum placement score of 50 points, taking the competition to a tiebreaker based on the review scores.  argolite secured second place over Ghostar by a margin of only 0.7 points, coming in at 93.86, including the highest individual competition score amongst the top three with 99.13. That high score couldn’t stop first place - Standlove stood head and shoulders over the rest with an average review score of 98.19.</p>
