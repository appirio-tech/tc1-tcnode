<%--
  ...
  -
  - Description: This page shows project details for content creation competitions.
--%>
<%@ page language="java" %>
...
<head>
<title>TopCoder Content Creation Competitions</title>
...
<table cellspacing="0" class="formFrame" align="center" width="530">
    <tr>
        <td class="projectTitles" nowrap="nowrap">Content Creation Project -
...
First Checkpoint: When the winning solution is submitted and review board suggestions are integrated.
Second Checkpoint: Marked by the completion of the Deployment phase of the project.</p>
...
<p>
Final payment is conditional on acceptance of the fully functional submission by the Content Creation Review Board
</p>
...
<span class="bigRed">Your ability to participate in this competition is contingent on the agreement to the Content Creation Terms of Work.</span>
</p>
