<%--
  ...
  -
  - Description: This is the page for listing the members of the Architecture review board. It displays the list of
...
<html>
<head>
    <title>Architecture Review Board at TopCoder</title>
    ...
    <tr valign="top">
        ...
        <td width="180">
            <jsp:include page="/includes/global_left.jsp">
                <jsp:param name="node" value="architecture_review_board"/>
            </jsp:include>
        </td>
        <!-- Left Column Ends -->
        ...
        <td class="bodyText" width="100%">
            <jsp:include page="/page_title.jsp">
                ...
                <jsp:param name="title" value="Meet the Architecture Review Board"/>
            </jsp:include>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="bodyText"><img src="/i/clear.gif" width="240" height="1" border="0" alt=""><br>
                        ...
                        <p>TopCoder Software utilizes past software architecture winners and accomplished TopCoder
                            competitors to staff the Architecture Review Board. These reviewers verify that each architecture
                            submission meets the required functionality, coding style, adheres to the architecture
                            requirements and contains a suitable test suite.</p>

                        <p>The following members have agreed to participate on the TopCoder Architecture Review Board:</p>
                    </td>
                </tr>
            </table>
                ...
                <rsc:iterator list="<%=memberList%>" id="resultRow">
                    ...
                    <td>
                        <div align="center">
                            ...
                            <span class="bodyText">
                                <tc-webtag:handle coderId='<%=resultRow.getIntItem("user_id")%>' context="architecture"/>
                            </span>
                        </div>
                    </td>
            ...
            <p align="middle"><a href="mailto:support@topcoder.com" class="bodyText">Have a question about the
                TopCoder Architecture Review Board?</a></p>
            <p><br/></p>
        </td>
        <!-- Center Column Ends -->
        ...
        <td width="170"><img src="/i/clear.gif" width="170" height="1" border="0" alt=""><br/>
            <jsp:include page="/public_right.jsp">
                ...
                <jsp:param name="level2" value="architecture"/>
            </jsp:include>
        </td>
        <!-- Right Column Ends -->
