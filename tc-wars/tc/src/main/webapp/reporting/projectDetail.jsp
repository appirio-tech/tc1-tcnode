<%--
  ...
  -
  - Description: This page shows project details for reporting competitions.
--%>
<%@ page language="java" %>
...
<head>
<title>TopCoder Reporting Competitions</title>
...
<table cellspacing="0" class="formFrame" align="center" width="530">
    <tr>
        <td class="projectTitles" nowrap="nowrap">Reporting Project -
...
<p>
Final payment is conditional on acceptance of the fully functional submission by the Reporting Review Board
</p>
...
<span class="bigRed">Your ability to participate in this competition is contingent on the agreement to the Reporting Terms of Work.</span>
</p>
