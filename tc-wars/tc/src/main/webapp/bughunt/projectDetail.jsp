<%--
  ...
  -
  - Description: This page shows project details for Bug Hunt competitions.
--%>
<%@ page language="java" %>
...
<head>
<title>TopCoder Bug Hunt Competitions</title>
...
<table cellspacing="0" class="formFrame" align="center" width="530">
    <tr>
        <td class="projectTitles" nowrap="nowrap">Bug Hunt Project -
