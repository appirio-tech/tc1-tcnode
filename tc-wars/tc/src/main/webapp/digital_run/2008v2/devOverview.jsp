...
<br /><br />
Each challenge posted in <a href="/tc?module=ViewActiveContests&amp;ph=113">Component Development</a>, <a href="/tc?module=ActiveContests&amp;pt=14">Assembly</a>, <a href="/tc?module=ActiveContests&amp;pt=13">Test Suites</a>, <a href="/tc?module=ActiveContests&amp;pt=19">UI Prototypes</a>, and <a href="/tc?module=ActiveContests&amp;pt=24">RIA Builds</a> will carry a point value. Placement points will be awarded based on the number of submissions that pass review, as follows:
<br /><br />
