...
<br /><br />
The Prize Pool for the Design Cup will grow with every competition posted within that month's timeframe. TopCoder will set a guaranteed minimum Prize Pool of $10,000 for the Design Cup per month (the pool will never be less than that amount). Every challenge launched has a specific amount of points associated to it. Each point adds $1 to the Design Cup Prize Pool. For example, if we launch a component design competition on July 12, 2009 with 800 Digital Run points then TopCoder will add $800 to the Design Cup for July 2009. The more challenges we launch, the larger the Design Cup Prize Pool will grow.
<br /><br />
