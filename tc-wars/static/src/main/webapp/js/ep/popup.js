...
function popUp(popper,popupID) {
    ...
    var popupAbsWidth = popperPos[0] + document.getElementById("pageContent").offsetLeft + popper.offsetWidth + objPopUp.offsetWidth;
    // distance from top side of the document to bottom side of SE placed popup
    var popupAbsHeight = popperPos[1] + document.getElementById("pageContent").offsetTop + popper.offsetHeight + objPopUp.offsetHeight;
...
function findPopperPos(obj) {
    ...
    if (obj.offsetParent) {
        ...
        curLeft = obj.offsetLeft - document.getElementById("pageContent").offsetLeft;
        curTop = obj.offsetTop - document.getElementById("pageContent").offsetTop;
