...
(function ($, window, document) {
    ...
    */
    _oExt.oStdClasses = {
        ...
        /* Features */
        "sWrapper": "contestTable",
        "sFilter": "dataTables_filter",
        "sInfo": "pagingInfo",
        "sPaging": "pager paging_", /* Note that the type is postfixed */
        "sLength": "pagerContainer",
        ...
        "full_numbers": {
            ...
            */
            "fnInit": function (oSettings, nPaging, fnCallbackDraw) {
                ...
                nPrevious.innerHTML = "<a href='javascript:;'>" + oSettings.oLanguage.oPaginate.sPrevious + "</a>";
                nNext.innerHTML = "<a href='javascript:;'>" + oSettings.oLanguage.oPaginate.sNext + "</a>";
    ...
    $.fn.dataTable = function (oInit) {
        ...
        function classSettings() {
            ...
            */
            this.oLanguage = {
                ...
                "sLengthMenu": "<span class='plainText'>Display :</span> _MENU_ <span class='plainText'>Contests/ Page</span>",
                "sZeroRecords": "No matching records found",
                "sEmptyTable": "No data available in table",
                "sLoadingRecords": "Loading...",
                "sInfo": "Displaying <strong>_START_</strong> to <strong>_END_</strong> of <strong>_TOTAL_</strong>",
                "sInfoEmpty": "Displaying <strong>0</strong> to <strong>0</strong> of <strong>0</strong>",
        ...
        */
        function _fnFeatureHtmlLength(oSettings) {
            ...
            var sStdMenu = '<select size="1" ' + sName + ' class="select">';
            var i, iLen;
            ...
            sStdMenu += "<option value='" + $("#contestTable tbody tr").length + "'>All</option>";
            sStdMenu += '</select>';
            ...
            nLength.innerHTML = oSettings.oLanguage.sLengthMenu.replace('_MENU_', sStdMenu) + "<div class='clear'></div>";
