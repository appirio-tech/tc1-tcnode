...
/**
 * @author dok
 * @version $Revision: 54027 $ Date: 2005/01/01 00:00:00
...
public class Submit extends FullRegSubmit {
   ...
   protected void registrationProcessing() throws TCWebException {
    ...
    protected void setNextPage() {
        if (hasErrors()) {
            setNextPage(getSessionInfo().getSecureAbsoluteServletPath()+"?"+Constants.MODULE_KEY+"="+
                    Constants.VICC_REG_MAIN+"&"+Constants.EVENT_ID+"6&"+Constants.COMPANY_ID+"=17942");
            ...
            if (regInfo.isNew()) {
                buf.append(Constants.VICC_REG_SUCCESS_PAGE);
            } else {
                buf.append(Constants.VICC_UPDATE_SUCCESS_PAGE);
            }
    ...
    private String getUrl(String code) {
        ...
        buf.append(Constants.MODULE_KEY);
        buf.append("=");
        buf.append(Constants.VICC_ACTIVATION);
        buf.append("&");
