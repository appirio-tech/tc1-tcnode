			...
			display : function(eleAlignTo)
			{
				...
				if (c.inline) {
					...
					cssRules = {
						...
						'left'	:	eleOffset.left + c.horizontalOffset + offsetForIcon
					};
				...
				var datePickerWidth = $('#'+attrs.id).width();
				var allEleOffsetLeft = (eleOffset.left + c.horizontalOffset + offsetForIcon + datePickerWidth);
				if(allEleOffsetLeft > $createIn.width()){
					$('#'+attrs.id).css('left',cssRules.left - datePickerWidth - offsetForIcon - 6);
				}
