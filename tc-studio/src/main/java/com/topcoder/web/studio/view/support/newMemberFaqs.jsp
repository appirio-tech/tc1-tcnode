            ...
            <div id="content">
                <div class="contentTop">
                    <div class="contentMiddle">
                        ...
                        <p>
                        <a href="#QA_5-1">How many submissions can I upload to a challenge?</strong></a><br />
                        <a href="#QA_5-2">How many of my submissions will be considered for a challenge?</strong></a><br />
                        ...
                        Studio holds competitions for many areas of graphic design and web design/development. From logo challenges, web design, print and apparel -  to Flash, Flex 3, JavaScript and widget design, you're sure to find an outlet for your creativity. Competitions are currently posted in two ways: 1) Studio-managed challenges which are held by clients who use Studio information architects and other resources to manage their challenges, and 2) TopCoder Direct-managed challenges which are managed completely by clients.
                        </a></p>
                        <p>
                        ...
                        Prizes vary according to what the client wants to pay, the type of project and the amount of work involved. You'll see simple icon or banner challenges listed for a couple hundred dollars, while prototypes and widget builds may go for a couple of thousand dollars. High profile challenges can go for even more!
                        </p>
                        <p>
                        ...
                        Any visitor to Studio can view challenge details. However, in order to compete, you must be a TopCoder member and you must do the following:<br />
                        Register for the challenge you wish to enter. In order to view and download any supporting documentation for a challenge, you must register for that specific challenge. Registering does not mean you are obligated to compete.
                        ...
                        Each challenge has detailed information within the challenge details that you should follow. If you can't find your answers there, you can visit that challenge's forum and ask questions. Your fellow members, Studio admins and the client will do their best to help clarify anything you need.
                        </p>
                        <p>
                        ...
                        All designs go through an initial screening phase. Submissions are screened against any requirements the client has specified and any copyright infringement or cheating. You will receive an email notification about your submission's status once it has been screened. If you submit early enough in a challenge, and your submission fails screening, you have the opportunity to resubmit before the challenge ends. Once final screening is completed, the client can make their winner selection(s).
                        </p>
                        <p>
                        <a name="QA_2-6"><strong>Hey, I won! How do I get paid?</strong></a><br />
                        In order to get paid, you must submit an IRS tax form. You will also choose how you would like to get paid (wire transfer, check or PayPal). All challenge payments are scheduled and posted to your Payments page on TopCoder within 7 days of winning a challenge. Your payment is then sent the following month, [within the schedule outlined at the bottom of this linked help file]. (link to payment schedule table in this FAQS)
                        </p>
                        ...
                        We have set up the Assignment Document to cover future entries for two reasons. First, having the Assignment Document cover future entries reduces the amount of paperwork for members and TopCoder. Second, it also relieves members from having to go through this process for each challenge. 
                        </p>
                        <p>
                        ...
                        You should sign and return the Assignment Document immediately after registering for your first Studio challenge. We must receive and process your signed Assignment Document before you will be able to upload any work to the Studio website. It can take up to one full business day to process your Assignment Document. See the processing timeline table (below) to determine when you should send your Assignment Document.
                ...
                <strong>Remember: You only need to do this ONE time to participate in all Studio challenges.</strong>
                        ...
                        Your submission cannot contain any stock art unless the challenge details specifically allow it. The majority of challenges on Studio only allow you to submit designs that you have created yourself. Please be sure you understand the Terms and check each challenge for more information about copyright issues before you submit. 
                        </p>
                        <p>
                        <a name="QA_4-2"><strong>Can I include artwork or code that is free or open source?</strong></a><br />
                        Your submission cannot contain any artwork or code that is labeled "free" or is in the public domain unless the challenge specifically allows it. 
                        </p>
                        <p>
                        ...
                        You should never "grab" screenshots or photos from the web or stock art sites to use as placeholders. You can, however, use images the client provides for that challenge. Otherwise, please create your own placeholder images.
                        </p>
                        <p>
                        ...
                        If you are concerned that your submission will fail, you should explain your concerns in the challenge forum and/or send an email to the Studio admins. When it doubt, read the challenge details again and look for any restrictions or allowances for copyrighted materials. Most challenges will only allow you to submit designs you have created yourself.
                        </p>
                        <p>
                        ...
                        <h3>Submission Formatting, Uploading and Screening Questions</h3>
                        <p>
                        <a name="QA_5-1"><strong>How many submissions can I upload to a challenge?</strong></a><br />
                        You may upload as many submissions as you like, however, each challenge limits how many submissions from each member will be eligible for consideration by the client. (See next question). This is why you will rank your submissions as you upload them, or after you've uploaded. 
                        </p>
                        <p>
                        <a name="QA_5-2"><strong>How many of my submissions will be considered for a challenge?</strong></a><br />
                        ...
                        - Before the submission deadline: Yes. If you submit early enough in the challenge, your submission is likely to get screened before the submission deadline. If your submission fails, you have the opportunity to fix problems and resubmit.
                        - After the deadline: No. A failed submission cannot be revised and reconsidered for a challenge after the deadline. All screening decisions are final. Studio encourages you to submit as early as possible so that you can fix any problems if your submission fails screening before the challenge deadline.
                        </p>
                        <p>
                        <a name="QA_5-8"><strong>When will final screening be complete?</strong></a><br />
                        The majority of challenges go through a final screening by Studio admins within 12 hours after the submission phase deadline. 
                        </p>
                        <p>
                        <a name="QA_5-9"><strong>What is included in my submission?</strong></a><br />
                        Your entire challenge submission will include three elements: <br />
                        ...
                        <br />Your preview image: The file you choose here represents your entire submission and is the first thing a client sees when evaluating your submission. It is turned into a thumbnail and displayed on the Studio site. Some challenges have specific requirements for Preview images - please be sure to read the challenge specification thoroughly.
                        </p>
                        ...
                        No. When you submit to a challenge, your source files are not shown on the Studio web site. We only show your submission files. If your submission wins a prize placement, the IP rights of your source files will transfer to the client.  
                        </p>
                        <p>
                        ...
                        Your submission Zip file will be created based on the information you find on the challenge Details page. 
                        </p>
                        <p>
                        Here are some examples: 
                        <strong>XYZ Logo challenge</strong><br />
                        One (1) JPG or PNG file containing your logo design.<br />
                        <strong>XYZ Web Design Storyboard challenge</strong><br />
                        Five (5) JPG or PNG files showing each screen of your design.<br />
                        <strong>XYZ Application Prototype challenge</strong><br />
                        ...
                        Your source Zip file will be created based on the information you find on the challenge Details page. 
                        Here are some examples: 
                        <strong>XYZ Logo challenge</strong><br />
                        ...
                        Your preview image can be one of your JPG files from your submission files if the challenge is graphical, or it can be a screenshot of one of the pages/screens your have programmed in coding challenges. Some challenges have specific requirements for Preview images - please be sure to read the challenge specification thoroughly.
                        </p>
                        <p>
                        ...
                        At the conclusion of each challenge, after the client has made winner selections, the challenge Administrator will notify winners via email with instructions on how to get paid. This notification will arrive within 7 days of winner designation. 
                        </p>
                        <p>
                        <a name="QA_6-2"><strong>When is my payment scheduled for processing?</strong></a><br />

                        TopCoder begins the payment process for Studio challenges one business day after the final files for the challenge have been delivered by the winner(s). 
                        </p>
                        <p>
