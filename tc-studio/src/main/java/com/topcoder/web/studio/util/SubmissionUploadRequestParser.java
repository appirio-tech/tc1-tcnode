...
/**
 * <p>A custom {@link com.topcoder.servlet.request.RequestParser} to be plugged into <code>File Upload</code> component 
 * for handling the requests for uploading <code>Studio</code> submissions. The main goal of this parser is to notify 
 * intended listener on uploading progress.</p>
 * 
 * @author isv
 * @version 1.0 (Upload Progress Bar assembly)
 */
public class SubmissionUploadRequestParser implements RequestParser {
    ...
    /**
     * <p>Constructs new <code>SubmissionUploadRequestParser</code> instance. This implementation does nothing.</p>
     */
    public SubmissionUploadRequestParser() {
    }

    /**
     * <p>Constructs new <code>SubmissionUploadRequestParser</code> instance to be used for notifying the specified 
     * listener on uploading progress.</p>
     * 
     * @param listener a <code>SubmissionUploadListener</code> to be notified on uploading progress.
     * @throws IllegalArgumentException if specified <code>listener</code> is <code>null</code>. 
     */
    public SubmissionUploadRequestParser(SubmissionUploadListener listener) {
        if (listener == null) {
            throw new IllegalArgumentException("The parameter [listener] is NULL");
        }
    ...
    public void parseRequest(ServletRequest request) throws RequestParsingException {
        if (this.listener != null) {
            this.listener.onStart(request.getContentLength());
        }
        ...
        try {
            ...
            this.in = new ServletInputStreamWrapper(request.getInputStream(), this.listener);
