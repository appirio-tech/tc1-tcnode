...
public class JiraSoapServiceServiceLocator extends org.apache.axis.client.Service implements com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JiraSoapServiceService {
    ...
    public com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JiraSoapService getJirasoapserviceV2() throws javax.xml.rpc.ServiceException {
    ...
    public com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JiraSoapService getJirasoapserviceV2(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JirasoapserviceV2SoapBindingStub _stub = new com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JirasoapserviceV2SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JiraSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JirasoapserviceV2SoapBindingStub _stub = new com.topcoder.www.bugs.rpc.soap.jirasoapservice_v2.JirasoapserviceV2SoapBindingStub(new java.net.URL(JirasoapserviceV2_address), this);
                _stub.setPortName(getJirasoapserviceV2WSDDServiceName());
                return _stub;
            }
        }
