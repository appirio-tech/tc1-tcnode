...
To prevent any watch from being automatically deleted, toggle the "save" option.</span>
                ...
                <form name="form1" method="post" action="<%=sessionInfo.getServletPath()%>">
                    ...
                    <div align="right">
                        <input type="image" src="/i/events/winformula/interface/btnUpdate.png" alt="Update" onclick="form1.<%=ForumConstants.STATUS%>.value='<%=ForumConstants.STATUS_UPDATE%>'"/>
                    </div>
...
<form name="form3" method="post" action="<%=sessionInfo.getServletPath()%>">
    ...
    <div align="right">
        <input type="image" src="/i/events/winformula/interface/btnUpdate.png" alt="Update" onclick="form3.<%=ForumConstants.STATUS%>.value='<%=ForumConstants.STATUS_UPDATE%>'"/>
    </div>
