                ...
                <table cellpadding="0" cellspacing="0" class="rtTable">
                    <form name="form1" method="post" action="<%=sessionInfo.getServletPath()%>">
                        ...
                        <tr><td class="rtFooter">
                            <input type="image" src="/i/events/winformula/interface/btnPost.png" class="rtButton" alt="Post" onClick="form1.module.value='PostMessage'"/>
                            <input type="image" src="/i/events/winformula/interface/btnPreview.png" class="rtButton" alt="Preview" onClick="form1.module.value='PreviewMessage'"/>
                            <%    if (forum.isAuthorized(ForumPermissions.CREATE_MESSAGE_ATTACHMENT)) { %>
                                <%    if (postMode.equals("Edit")) { %>
                                    <input type="image" src="/i/events/winformula/interface/btnAttachFiles.png" class="rtButton" alt="Attach Files" onClick="form1.module.value='EditAttachments'"/>
                                <%    } else { %>
                                    <input type="image" src="/i/events/winformula/interface/btnAttachFiles.png" class="rtButton" alt="Attach Files" onClick="form1.module.value='AttachFiles'"/>
                                <%    } %>
                            <%    } %>
