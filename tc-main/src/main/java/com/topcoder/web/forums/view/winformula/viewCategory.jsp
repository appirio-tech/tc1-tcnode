...
<div>
    <div style="float:right;">
        <a href="?module=RSS&<%=ForumConstants.CATEGORY_ID%>=<%=forumCategory.getID()%>"><img alt="RSS" border="none" src="/i/events/winformula/interface/btnRSS.png"/></a>
    </div>
<span class="small">
<% if (forumCategory.getID() != 1) { %>
