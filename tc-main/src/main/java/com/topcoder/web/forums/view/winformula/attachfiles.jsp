...
<table cellpadding="0" cellspacing="0" class="rtbcTable">
				...
				<input type="image" src="/i/events/winformula/interface/btnAttachFiles.png" class="rtButton" alt="Attach Files" onClick="form1.module.value='Attach'"/>
				
				<%-- Cancel --%>
				<%	if (postMode.equals("Edit")) {
						String urlNext = sessionInfo.getServletPath() + "?module=Message&" + ForumConstants.MESSAGE_ID + "=" + message.getID(); %> 
						<a href="<%=urlNext%>"><img src="/i/events/winformula/interface/btnCancel.png" class="rtButton" alt="Cancel"/></a>
				<%	} else { %>
						<input type="image" src="/i/events/winformula/interface/btnCancel.png" class="rtButton" alt="Cancel" onClick="form1.module.value='Post'"/>
				<%	} %>
